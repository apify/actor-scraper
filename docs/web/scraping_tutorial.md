<!-- MM:START (injectFile:path=./partials/intro.md) -->
 
<!-- MM:END -->

### Title
![actor title](../all/img/title-01.png "Finding actor title in DevTools.")
...
![actor title selector](../all/img/title-02.png "Finding actor title in DevTools.")
...
![actor description selector](../all/img/description.png "Finding actor description in DevTools.")
